...
-- usql_bin() removed (Phase 5) — now using RPC sidecar
-- ensure_dependency() removed (Phase 5) — RPC eliminates CLI dependencies
...
-- run_usql_json() removed (Phase 5) — replaced by RPC async methods
...
-- column_query() removed (Phase 5) — use rpc.columns() instead

-- primary_key_query() removed (Phase 5) — use rpc.primary_key() instead
